...
namespace JaKCass
{
    public static class ModeManager
    {
        ...
        private static int[] abilitySequence = new int[] { 1, 3, 3, 2, 3, 4, 1, 3, 3, 1, 4, 1, 1, 2, 2, 4, 2, 2 };
        ...
        {
            if ((Orbwalker.ActiveModesFlags == Orbwalker.ActiveModes.Combo || Orbwalker.ActiveModesFlags == Orbwalker.ActiveModes.Harass) && Program.ShouldDisableAA)
            {
